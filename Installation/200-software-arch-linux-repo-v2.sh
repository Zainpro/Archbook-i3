...
echo "Playcorefactory required software"

#sudo pacman -S --noconfirm --needed git
sudo pacman -S --noconfirm --needed ffmpeg
sudo pacman -S --noconfirm --needed libfdk-aac
sudo pacman -S --noconfirm --needed rtmpdump
#sudo pacman -S --noconfirm --needed vlc
#sudo pacman -S --noconfirm --needed mpv
sudo pacman -S --noconfirm --needed youtube-dl
sudo pacman -S --noconfirm --needed aria2c
